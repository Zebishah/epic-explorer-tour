...
import { addTransport, countTransports, deleteTransport, filterTransport, getFormData, getTransport, openTransport, relatedTransport, searchTransportById, searchTransportByName, transportPayment, updateTransport } from '../Controllers/Transport-Controllers.js';
...
TransportRoutes.post('/RelatedTransport', relatedTransport);
