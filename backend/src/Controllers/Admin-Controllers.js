...
export const createAdmin = async (req, res, next) => {
  ...
  if (admin) {
    return res
      ...
      .json({
        success: false,
        message: "admin with this info already exists",
        statusCode: 400,
      });
  }
  //hashing password
...
export const adminLogin = async (req, res, next) => {
  ...
  if (email.trim() === "" || password.trim() === "") {
    return res
      ...
      .json({
        success: false,
        message: "enter ur credentials first",
        statusCode: 400,
      });
  }
  //fetching admin
...
export const getAdmins = async (req, res, next) => {
  ...
  return res
    ...
    .json({
      success: true,
      message: "here are your all admins",
      admins: admin,
      statusCode: 200,
    });
};
  ...
  try {
    ...
    try {
      ...
      return res
        ...
        .json({
          success: true,
          message: "Admin account has been balanced successfully",
          Balance: updatedBalance,
          balanceDB: updatedBalance,
          statusCode: 400,
        });
    } catch (error) {
      return res
        ...
        .json({
          ...
          error: error.response.data.extras.result_codes,
          statusCode: 500,
        });
    }
  } catch (error) {
    ...
    return res
      ...
      .json({
        success: false,
        message: "Error loading account or building transaction",
        error: error,
        statusCode: 500,
      });
  }
...
export const UserHotelBookings = async (req, res, next) => {
  ...
  if (!HotelBookings) {
    return res
      .status(400)
      .json({ success, message: "no HotelBookings are here", statusCode: 400 });
  }
  return res
    .status(200)
    .json({
...
export const UserTourBookings = async (req, res, next) => {
  ...
  if (!TourBookings) {
    return res
      .status(400)
      .json({ success, message: "no TourBookings are here", statusCode: 400 });
  }
