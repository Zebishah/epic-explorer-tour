...
export const addTourServices = async (req, res, next) => {
  ...
  if (servicesIT) {
    return res
      ...
      .json({
        success: false,
        message: "ServicesItrenary related to this tour is already present",
      });
  }
  try {
    servicesIT = new ItrenaryServicesTour({
      tourId,
      priceIncludes,
      priceExcludes,
      activities: services,
  ...
  let notificationAdmin = new NotificationsAdmin({
    accommodationName: "Tour Service added Successfully",
    Category: "Tour-Service Added",
    message: `New Tour Service is added to our website is added to our site`,
    date,
  });
  ...
  return res
    ...
    .json({
      success: true,
      message: "Tour Services and itrenary is created",
...
export const getTourServicesIT = async (req, res, next) => {
  ...
  return res
    ...
    .json({
      success: true,
      message: "here are your all ServicesIteranries of tour",
      ServicesIt: ServicesIt,
    });
};
