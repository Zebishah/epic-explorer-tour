...
export const addHotelServices = async (req, res, next) => {
  ...
  if (checkServicesIT) {
    return res
      ...
      .json({
        success: false,
        message: "Hotel Services and itrenary is already here",
      });
  }

  let servicesIT;
  try {
    servicesIT = new ItServicesHotel({
      roomId,
      priceIncludes,
      priceExcludes,
      services,
  ...
  if (!servicesIT) {
    return res
      ...
      .json({
        success: false,
        message: "Hotel Services and itrenary is not created",
      });
  }
  let date = new Date();
  let notificationAdmin = new NotificationsAdmin({
    accommodationName: "Hotel Service added Successfully",
    Category: "Hotel-Service Added",
    message: `New Hotel Service is added to our website is added to our site`,
    date,
  });
  ...
  return res
    ...
    .json({
      success: true,
      message: "Hotel Services and itrenary is created",
...
export const getHotelServicesIT = async (req, res, next) => {
  ...
  if (!ServicesIt) {
    return res
      ...
      .json({
        success: false,
        message: "no ServicesItrenary found in database",
      });
  }
  ...
  return res
    ...
    .json({
      success: true,
      message: "here are your all ServicesIteranries of Hotels",
      ServicesIt: ServicesIt,
    });
};
