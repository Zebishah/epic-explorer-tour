...
const HotelRelRooms = () => {
  return (
    <div className="bg-light-black">
      ...
      <div className="flex items-center justify-center min-h-screen p-8 overflow-hidden bg-dark">
        <div className="container mx-auto">
          <div className="py-4 mb-8 text-center rounded bg-yellows">
            <h1 className="text-2xl font-bold">Serena Hotel Rooms</h1>
          </div>
