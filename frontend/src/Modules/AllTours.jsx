...
const AllTours = () => {
  ...
  const { tours, filterTours, errorSearch } = useSelector(
  ...
  useEffect(() => {
    if (filterTours && filterTours.tours) {
      setTours(filterTours.tours);
      console.log(Tours);
    }
  }, [filterTours]);
  ...
  if (Tours && Array.isArray(Tours)) {
    ...
    currentTours = Tours.slice(startIndex, startIndex + itemsPerPage);
  } else {
        ...
        <div className="w-full mx-auto ">
          ...
          <div className="flex flex-col gap-8 lg:flex-row">
            ...
            >
              ...
              <div>
                <h4 className="mb-2 text-lg font-semibold font-radios ">
                  price
                </h4>
                {[
                  "2000-3000",
            ...
            <div className="flex flex-col w-full gap-y-3 lg:w-3/4">
              <div className="text-center bg-[#3654ff] py-4 rounded mb-8 text-white">
                <h1 className="text-2xl font-bold">Search for any Tour</h1>
              </div>
