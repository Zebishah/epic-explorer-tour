...
const UserProfile = () => {
  ...
  return (
    <>
      <ToastContainer />
      <div
        className="flex flex-col min-h-screen transition-all duration-500 ease-in-out bg-center bg-cover"
        ...
        <div className="flex flex-row gap-x-6 h-full w-full overflow-hidden bg-opacity-0 bg-[#3654ff] smd:mt-40 mt-20">
          ...
          <div className="flex flex-col items-center justify-center flex-grow p-6">
            ...
            <div className="container max-w-screen-lg mx-auto ">
              ...
              <div className="p-4 px-4 mb-6 bg-white bg-center rounded-lg shadow-lg shadow-fade-black md:p-8">
