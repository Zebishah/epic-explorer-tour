...
import { contactMessage } from "../Redux/Slices/showAccommodationsSlice";
...
const ContactForm = () => {
  ...
  const { contact } = useSelector((state) => state.showAccommodations);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(contactMessage(firstName, lastName, email, message));
    setFirstName("");
    setLastName("");
    setEmail("");
    setMessage("");
  ...
  return (
    <>
      ...
      <div className="flex flex-col flex-wrap items-center justify-center p-8 space-y-14 ">
        ...
        <div className="max-w-screen-lg p-5 mx-auto shadow-lg shadow-fade-black rounded-xl">
          <div className="grid grid-cols-1 md:grid-cols-12 ">
            <div className="bg-[#206eff] md:col-span-4 p-10 text-white">
              <p className="mt-4 text-sm font-bold leading-7 uppercase font-radios">
                Contact
              </p>
              <h3 className="text-3xl font-extrabold leading-normal tracking-tight sm:text-4xl font-joining">
              ...
              <div className="flex items-center mt-5">
                <svg
                  className="h-6 mr-2 font-bold text-white"
                  fill="currentColor"
                  version="1.1"
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
            ...
            <form
              ...
              method="post"
              className="p-10 md:col-span-8"
            >
              <div className="flex flex-wrap mb-6 -mx-3">
                <div className="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                  <label
                    className="block uppercase tracking-wide text-[#3654ff] text-sm font-radios font-bold mb-2"
                    htmlFor="grid-first-name"
                  >
                    First Name
                  </label>
                  <input
                    className="block w-full px-4 py-3 mb-3 leading-tight text-white bg-blue-400 rounded appearance-none placeholder:text-white focus:outline-none "
                    id="grid-first-name"
                    type="text"
                    placeholder="Jane"
                    value={firstName}
                ...
                <div className="w-full px-3 md:w-1/2">
                  ...
                  <input
                    className="block w-full px-4 py-3 leading-tight text-white bg-blue-400 border border-gray-200 rounded appearance-none placeholder:text-white focus:outline-none focus:border-gray-500"
                    id="grid-last-name"
                    type="text"
                    placeholder="Doe"
                    value={lastName}
              ...
              <div className="flex flex-wrap mb-6 -mx-3">
                <div className="w-full px-3">
                  ...
                  <input
                    className="block w-full px-4 py-3 mb-3 leading-tight text-white bg-blue-400 border border-gray-200 rounded appearance-none placeholder:text-white focus:outline-none focus:border-gray-500"
                    id="grid-email"
                    type="email"
                    placeholder="********@*****.**"
                    value={email}
              ...
              <div className="flex flex-col justify-between w-full px-3 gap-y-3 smd:flex-row ">
                <div className="md:flex md:items-center">
                  <label className="block font-bold text-gray-500">
                    ...
                    />
                    <span className="text-sm text-white font-radios">
                ...
                <button
                  type="submit"
                  className="w-[90%] p-2 smd:w-[40%] hover:before:bg-red rounded-xl relative h-auto overflow-hidden bg-white ext-white px-3 text-blue-600 shadow-lg transition-all ease-in-out before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[#3654ff] before:transition-all before:duration-500 hover:text-white hover:shadow-fade-black hover:before:left-0 hover:before:w-full"
                >
