import image from "../image/Family Packages (15).png";
...
const AllTransport = () => {
  ...
  const { transport, filterTransport } = useSelector(
  ...
  useEffect(() => {
    if (filterTransport && filterTransport.transport) {
      setTransport(filterTransport.transport);
      console.log(filterTransport.transport);
    }
  }, [filterTransport]);
  ...
  let bookTransport = (id) => {
    navigate(`/BookTransport?id=${encodeURIComponent(id)}`);
  };
  let totalPages = 0;
  let currentTransport = [];
  if (Transport && Array.isArray(Transport)) {
    totalPages = Math.ceil(Transport.length / itemsPerPage);
    const startIndex = (currentPage - 1) * itemsPerPage;
    currentTransport = Transport.slice(startIndex, startIndex + itemsPerPage);
  } else {
    console.error("Tours is not an array:", Transport);
  }
      ...
      <div className="flex flex-col items-center justify-center w-full min-h-screen p-8 overflow-hidden bg-dark lg:flex-row gap-x-6">
        <div className="w-full mx-auto ">
          <div className="text-center bg-[#3654ff] py-4 rounded mb-8 text-white">
            <h1 className="text-2xl font-bold ">List of All Transport</h1>
          </div>
          ...
          <div className="flex flex-col gap-8 lg:flex-row">
            ...
            >
              <h3 className="mb-4 text-lg font-bold font-radios">Filters</h3>
              <div>
                <h4 className="mb-2 font-semibold font-radios ">price</h4>
                {[
                  "2000-3000",
                  "3000-4000",
                  "4000-5000",
              ...
              <div className="mt-4">
                <h4 className="mb-2 font-semibold font-radios">Category</h4>
                {["Luxury", "Cabs", "Coasters", "Mini Cars", "Vip Cars"].map(
                  (category) => (
                    <div key={category}>
                      <input
                        type="checkbox"
              ...
              <div className="mt-4">
                <h4 className="mb-2 font-semibold font-radios">
                  Members Limit
                </h4>
              ...
              <div className="mt-4">
                <h4 className="mb-2 font-semibold font-radios">Seater</h4>
                {["3", "4", "5", "7", "8", "9"].map((location) => (
                  <div key={location}>
                    <input
                      type="checkbox"
                      id={location}
            ...
            <div className="flex flex-col w-full gap-y-3 lg:w-3/4">
              <div className="text-center bg-[#3654ff] py-4 rounded mb-8 text-white">
                <h1 className="text-2xl font-radios">
                  Search for any Transport
                </h1>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-8">
                {currentTransport.length > 0 &&
                  currentTransport.map((tour, index) => (
                    <div
                    ...
                    >
                      ...
                      <div className="p-3 mt-2 bg-[#206eff] rounded-xl">
                        ...
                        <div className="flex justify-center mt-6">
                          <button
                            type="button"
                            onClick={() => bookTransport(tour._id)}
