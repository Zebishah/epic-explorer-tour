...
const Notification = ({ title, message }) => {
  return (
    <div className="bg-light-black border border-slate-300 w-[100%] h-20 shadow-lg rounded-md gap-4 p-4 flex flex-row items-center justify-center">
      <section className="flex flex-col items-center justify-start w-6 h-full">
        <svg
          width="100%"
      ...
      <section className="flex flex-col items-start justify-end h-full gap-1">
        <h1 className="text-xs antialiased font-semibold smd:text-lg text-yellows">
          {title}
        </h1>
        <p className="text-xs antialiased font-medium smd:text-sm text-yellows">
          {message}
        </p>
      </section>
    </div>
