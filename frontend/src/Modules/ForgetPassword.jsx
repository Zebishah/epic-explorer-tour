...
const ForgetPassword = () => {
  ...
  return (
    <div
      className="flex flex-col w-full h-screen bg-white gap-y-36"
      style={{
    ...
    >
      ...
      <main
        id="content"
        role="main"
        className="flex flex-col items-center justify-center w-full p-6 mx-auto gap-y-3"
      >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        id="email"
                        name="email"
                        className="block w-full px-4 py-3 text-sm text-black border-2 border-gray-300 rounded-md shadow-sm"
                        value={email}
        ...
        <p className="flex items-center justify-center mt-3 text-center divide-x">
          <a
