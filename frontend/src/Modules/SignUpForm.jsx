      ...
      <div className="flex items-center justify-center bg-white smd:w-1/2 sssm:w-full">
        <form className="" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="items-center justify-center ml-10 flex-flex-row gap-x-4">
              <span className="ml-2 text-sm text-blue-700 cursor-pointer font-radios">
                Already Have Account ?
              </span>

              <Link to={"/signIn"}>
                <span className="p-2 text-sm text-blue-700 transition-all duration-500 ease-in-out rounded-lg cursor-pointer hover:bg-blue-600 font-radios hover:text-white">
                  Login
                </span>
              </Link>
            </div>
